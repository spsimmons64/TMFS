...
export const DQDriversGrid = () => {
    ...
    const columns = [{
        ...
        id: "disqualified",
        width: "10.25%",
        header: "Disqualified Since",
        cellStyle: { textAlign: "center" },
        hdrAlign: "center",
        sortable: 1,
        render: (ndx) => <div className="short">{gridState.data[ndx].disqualified}</div>
    }, {
        id: "reason",
        width: "41%",
        ...
        hdrAlign: "center",
        sortable: 1,
        render: (ndx) => <div className="short">TBA</div>
    }, {
        id: "action",
        width: "8%",
        header: "Actions",
    ...
    return (
        <>
            {!driverForm
                ? <>
                    <PortalPlayGroundPageTitleStyle><h1>Disqualified Drivers</h1></PortalPlayGroundPageTitleStyle>
