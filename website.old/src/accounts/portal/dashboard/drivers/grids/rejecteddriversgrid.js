...
align-items:center;
`
export const RejectedDriversGrid = () => {
    ...
    useEffect(() => {
        if (globalState.account.recordid) {
            ...
            setGridUrl(`drivers?action=grid&parentid=${globalState.account.recordid}&route=review&entity=account`, false)
    ...
    return (
        <>
            {!driverForm
                ? <>
                    <PortalPlayGroundPageTitleStyle><h1>Rejected Drivers</h1></PortalPlayGroundPageTitleStyle>
