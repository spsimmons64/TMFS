...
class PDF(FPDF):
    ...
    def header(self):
        ...
        self.cell(w=7.5,h=.25,text="COPY OF DRIVER MEDICAL CARD",align="C")
...
def generate_medcard_pdf(file_medcard,driverid,filename):    
    ...
    pdf.add_page()       
    print_image(pdf,file_medcard,2,None,220)
